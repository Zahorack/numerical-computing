...
inline ostream &operator<<(ostream &o,const Symbolic &s)
{ s.print(o); return o; }

inline ostream &operator<<(ostream &o,const Equation &s)
{ s.print(o); return o; }

inline Symbolic operator+(const Symbolic &s)
{ return s; }

inline Symbolic operator+(const Symbolic &s1,const Symbolic &s2)
{ return Sum(s1,s2); }

inline Symbolic operator+(const int &s1,const Symbolic &s2)
{ return Symbolic(Number<int>(s1)) + s2; }

inline Symbolic operator+(const Symbolic &s1,const int &s2)
{ return s1 + Symbolic(Number<int>(s2)); }

inline Symbolic operator+(const double &s1,const Symbolic &s2)
{ return Symbolic(Number<double>(s1)) + s2; }

inline Symbolic operator+(const Symbolic &s1,const double &s2)
{ return s1 + Symbolic(Number<double>(s2)); }

inline Symbolic operator++(Symbolic &s)
{ return s = s + 1; }

inline Symbolic operator++(Symbolic &s,int)
...
inline Symbolic operator+=(Symbolic &s1,const Symbolic &s2)
{ return s1 = s1 + s2; }

inline Symbolic operator+=(Symbolic &s1,const int &s2)
{ return s1 = s1 + s2; }

inline Symbolic operator+=(Symbolic &s1,const double &s2)
{ return s1 = s1 + s2; }
...
inline Equation operator==(const Symbolic &s1,const Symbolic &s2)
{ return Equation(s1,s2); }

inline Equation operator==(const Symbolic &s1,int i)
{ return s1 == Symbolic(i); }

inline Equation operator==(int i,const Symbolic &s1)
{ return Symbolic(i) == s1; }

inline Equation operator==(const Symbolic &s1,double d)
{ return s1 == Symbolic(d); }

inline Equation operator==(double d,const Symbolic &s1)
{ return Symbolic(d) == s1; }

inline int operator!=(const Symbolic &s1,const Symbolic &s2)
{ return !s1.compare(s2); }

inline int operator!=(const Symbolic &s1,int i)
{ return s1 != Symbolic(i); }

inline int operator!=(int i,const Symbolic &s1)
{ return Symbolic(i) != s1; }

inline int operator!=(const Symbolic &s1,double d)
{ return s1 != Symbolic(d); }

inline int operator!=(double d,const Symbolic &s1)
{ return Symbolic(d) != s1; }

inline Symbolic sin(const Symbolic &s)
{ return Sin(s); }

inline Symbolic cos(const Symbolic &s)
{ return Cos(s); }

inline Symbolic tan(const Symbolic &s)
{ return sin(s) / cos(s); }

inline Symbolic cot(const Symbolic &s)
{ return cos(s) / sin(s); }

inline Symbolic sec(const Symbolic &s)
{ return 1 / cos(s); }

inline Symbolic csc(const Symbolic &s)
{ return 1 / sin(s); }

inline Symbolic sinh(const Symbolic &s)
{ return Sinh(s); }

inline Symbolic cosh(const Symbolic &s)
{ return Cosh(s); }

inline Symbolic ln(const Symbolic &s)
{ return Log(SymbolicConstant::e,s); }

inline Symbolic log(const Symbolic &a,const Symbolic &b)
{ return Log(a,b); }

inline Symbolic pow(const Symbolic &s,const Symbolic &n)
{ return Power(s,n); }

inline Symbolic operator^(const Symbolic &s,const Symbolic &n)
{ return Power(s,n); }

inline Symbolic operator^(const Symbolic &s,int i)
{ return Power(s,Symbolic(i)); }

inline Symbolic operator^(int i,const Symbolic &s)
{ return Power(Symbolic(i),i); }

inline Symbolic operator^(const Symbolic &s,double d)
{ return Power(s,Symbolic(d)); }

inline Symbolic operator^(double d,const Symbolic &s)
{ return Power(Symbolic(d),s); }

inline Symbolic exp(const Symbolic &s)
{ return SymbolicConstant::e ^ s; }

inline Symbolic sqrt(const Symbolic &s)
{ return s ^ (Number<int>(1) / 2); }

inline Symbolic factorial(const Symbolic &s)
{ return Gamma(s + 1); }

inline Symbolic gamma(const Symbolic &s)
{ return Gamma(s); }

inline Symbolic df(const Symbolic &s,const Symbolic &x)
{ return s.df(x); }

inline Symbolic df(const Symbolic &s,const Symbolic &x,unsigned int i)
{
 Symbolic r = s;
 while(i-- > 0) r = r.df(x);
 return r;
...
inline Symbolic &rhs(Equations &l,const Symbolic &lhs)
{
...
inline Symbolic &lhs(Equations &l,const Symbolic &rhs)
{
 Equations::iterator i = l.begin();
 for(i=l.begin();i!=l.end();++i)
...
template<> inline Symbolic zero(Symbolic) { return Number<int>(0); }

template<> inline Symbolic one(Symbolic) { return Number<int>(1); }
...
inline list<Symbolic> operator,(const int &x,const Symbolic &y)
{ return (Symbolic(x), y); }

inline list<Symbolic> operator,(const double &x,const Symbolic &y)
{ return (Symbolic(x), y); }

inline list<Symbolic> operator,(const Symbolic &x,const int &y)
{ return (x,Symbolic(y)); }

inline list<Symbolic> operator,(const Symbolic &x,const double &y)
{ return (x,Symbolic(y)); }
...
inline list<Symbolic> operator,(const list<Symbolic> &x,const int &y)
{ return (x, Symbolic(y)); }

inline list<Symbolic> operator,(const list<Symbolic> &x,const double &y)
{ return (x, Symbolic(y)); }
...
inline list<Symbolic> operator,(const int &x,const list<Symbolic> &y)
{ return (Symbolic(x), y); }

inline list<Symbolic> operator,(const double &x,const list<Symbolic> &y)
{ return (Symbolic(x), y); }

inline list<list<Symbolic> >
...
inline Equation operator,(const Symbolic &x, const Equation &e)
{
...
inline Equation operator,(const list<Symbolic> &x, const Equation &e)
{
 Equation p = e;
...
inline ostream &operator<<(ostream &o,const Equations &e)
{
...
inline ostream &operator<<(ostream &o,const list<Symbolic> &e)
{
...
inline Symbolic tr(const Symbolic &x) { return Trace(x); }

inline Symbolic trace(const Symbolic &x) { return Trace(x); }

inline Symbolic det(const Symbolic &x) { return Determinant(x); }

inline Symbolic determinant(const Symbolic &x) { return Determinant(x); }

inline Symbolic kron(const Symbolic &x,const Symbolic &y)
{ return Kronecker(x,y); }

inline Symbolic dsum(const Symbolic &x,const Symbolic &y)
{ return DirectSum(x,y); }

inline Symbolic hadamard(const Symbolic &x,const Symbolic &y)
{ return Hadamard(x,y); }

inline void pattern_match_TRUE(PatternMatches &l)
{
 PatternMatches p;
...
inline void pattern_match_FALSE(PatternMatches &l)
{ l = PatternMatches(); /* empty: no matches */ }

inline int pattern_match_AND(Equations &l, const Equation &e)
{
...
inline int pattern_match_AND(Equations &l, const Equations &e)
{
...
inline void pattern_match_AND(PatternMatches &l, const Equation &e)
{
...
inline void pattern_match_AND(PatternMatches &l, const Equations &e)
{
 PatternMatches::iterator i;
...
inline void pattern_match_AND(PatternMatches &l, const PatternMatches &e)
{
 PatternMatches::iterator i;
...
inline void pattern_match_OR(PatternMatches &l, const Equation &e)
{
 Equations eq;
 eq.push_back(e);
...
inline void pattern_match_OR(PatternMatches &l, const Equations &e)
{
 PatternMatches::iterator i;
...
inline void pattern_match_OR(PatternMatches &l, const PatternMatches &e)
{
